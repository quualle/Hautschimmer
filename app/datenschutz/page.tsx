    ...
    <div className="container mx-auto px-4 py-8 pt-24 min-h-screen">
      ...
      <section className="mb-6">
        ...
        <p className="mb-4">
          ...
          von Netlify: <a href="https://www.netlify.com/privacy/" target="_blank" rel="noopener noreferrer" className="text-[#C0A080] hover:underline">https://www.netlify.com/privacy/</a>
        </p>
        <p className="mb-4">
      ...
      <section className="mb-6">
        ...
        <p className="mb-2">15711 Königs Wusterhausen</p>
        <p className="mb-2">sowie</p>
        <p className="mb-2">Mussinanstraße 65</p>
        <p className="mb-2">92318 Neumarkt i.d.Opf (ab 13.10.2025)</p>
        <p className="mb-2">Telefon: 0173 8615766</p>
        <p className="mb-4">E-Mail: saskia.hautschimmer@gmail.com</p>
        <p className="mb-4">
        ...
        <h3 className="text-lg font-semibold mb-2 mt-4">Hinweis zur Datenweitergabe in die USA und sonstige Drittstaaten</h3>
        <p className="mb-4">
      ...
      <section className="mb-6">
        ...
        <h3 className="text-lg font-semibold mb-2 mt-4">Anfrage per E-Mail oder Telefon</h3>
        <p className="mb-4">
      ...
      <section className="mb-6">
        ...
        <p className="mb-4">
          ...
          <a href="https://www.google.com/analytics/terms/de.html" target="_blank" rel="noopener noreferrer" className="text-[#C0A080] hover:underline">
            https://www.google.com/analytics/terms/de.html
          </a>{' '}
          und unter{' '}
          <a href="https://policies.google.com/?hl=de" target="_blank" rel="noopener noreferrer" className="text-[#C0A080] hover:underline">
      ...
      <section className="mb-6">
        <h2 className="text-xl font-semibold mb-3">6. Plugins und Tools</h2>

        <h3 className="text-lg font-semibold mb-2 mt-4">Externe Buchungsplattform (Planity)</h3>
        <p className="mb-4">
        ...
        <p className="mb-4">
          ...
          <a href="https://www.planity.com/privacy" target="_blank" rel="noopener noreferrer" className="text-[#C0A080] hover:underline">
            https://www.planity.com/privacy
          </a>
        </p>

        <h3 className="text-lg font-semibold mb-2 mt-4">Google Maps</h3>
        <p className="mb-4">
        ...
        <p className="mb-4">
          ...
          <a href="https://policies.google.com/privacy?hl=de" target="_blank" rel="noopener noreferrer" className="text-[#C0A080] hover:underline">
      ...
      <section className="mb-6">
        <h2 className="text-xl font-semibold mb-3">7. Medizinische Daten</h2>
        <p className="mb-4">
