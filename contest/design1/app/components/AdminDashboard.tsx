            ...
            <div className="bg-white rounded-lg shadow-sm mb-6">
                <div className="flex border-b overflow-x-auto">
                    <button
                        ...
                        className={`px-3 sm:px-6 py-3 font-medium transition-colors text-sm sm:text-base whitespace-nowrap ${filter === 'all'
                    ...
                    <button
                        ...
                        className={`px-3 sm:px-6 py-3 font-medium transition-colors text-sm sm:text-base whitespace-nowrap ${filter === 'published'
                            ? 'text-rose-600 border-b-2 border-rose-600'
                            : 'text-gray-600 hover:text-gray-800'
                            }`}
                    >
                    ...
                    <button
                        ...
                        className={`px-3 sm:px-6 py-3 font-medium transition-colors text-sm sm:text-base whitespace-nowrap ${filter === 'draft'
                            ? 'text-rose-600 border-b-2 border-rose-600'
                            : 'text-gray-600 hover:text-gray-800'
                            }`}
                    >
                        ...
                        <tbody className="divide-y divide-gray-200">
                            {filteredArticles.map((article) => (
                                <tr key={article.id} className="hover:bg-gray-50">
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap">
                                        <span className={`inline-flex text-xs leading-5 font-semibold rounded-full px-2 py-1 ${article.status === 'published'
