                    ...
                    <div className="relative bg-white rounded-lg shadow-xl w-full max-w-7xl max-h-[90vh] flex flex-col">
                        ...
                        <div className="flex border-b px-6">
                            <button
                                ...
                                className={`px-4 py-3 font-medium transition-colors ${activeTab === 'edit'
                            ...
                            <button
                                ...
                                className={`px-4 py-3 font-medium transition-colors ${activeTab === 'preview'
                                    ? 'text-rose-600 border-b-2 border-rose-600'
                                    : 'text-gray-600 hover:text-gray-800'
                                    }`}
                            >
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={(e) => setEditedArticle({ ...editedArticle, author_id: e.target.value })}
                                            className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-rose-500 focus:border-transparent"
                                        />
                                    </div>
                                ...
                                <article className="max-w-4xl mx-auto">
                                    ...
                                    <header className="mb-8">
                                        ...
                                        <div className="flex items-center justify-between text-gray-600 mb-6">
                                            <div>
                                                <span className="font-medium">{editedArticle.author_id}</span>
